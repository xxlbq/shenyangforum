		...
		<td class="bodyline">
			...
			<table cellspacing="2" cellpadding="2" width="100%" align="center" border="0">
				<tr>
					...
					<#else>
						<#if !Request.forumdata.readonly>
							<a href="${Request.forumdata.JForumContext.encodeURL("/posts/showReply.action?start=${Request.forumdata.start}&topic_id=${Request.forumdata.topic.id}")}" rel="nofollow" class="icon_reply nav"><img src="${Request.forumdata.contextPath}/images/transp.gif" alt="" /></a>
						<#else>
							<#assign colspan = "2"/>
						</#if>
		  			</#if>
